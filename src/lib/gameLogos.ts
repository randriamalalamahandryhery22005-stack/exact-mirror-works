...
export const jetxLogo = jetxAsset.url;

/** Classe commune pour un rendu propre, centré et équilibré des logos. */
export const gameLogoClass = "w-full h-full object-contain object-center p-1.5";
